...
/* overall_header.html */
class __TwigTemplate_bb372d7a97738407c838ef5f655f4c9d09bc4dd60edaccbaa45cdb8721c5c3fc extends Twig_Template
{
...
";
            ...
            echo $_ROOT_PATH_;
            echo "styles/black/theme/fonts/font-awesome-4.5.0/css/font-awesome.min.css\" rel=\"stylesheet\">
";
        }
        // line 46
        echo "<link href=\"";
        if (isset($context["ROOT_PATH"])) { $_ROOT_PATH_ = $context["ROOT_PATH"]; } else { $_ROOT_PATH_ = null; }
        echo $_ROOT_PATH_;
        echo "styles/black/theme/fonts/glyphicons-pro-1.9.2/css/glyphicons.css\" rel=\"stylesheet\">
...
";
        ...
        if (($_S_CONTENT_DIRECTION_ == "rtl")) {
            ...
            if (isset($context["ROOT_PATH"])) { $_ROOT_PATH_ = $context["ROOT_PATH"]; } else { $_ROOT_PATH_ = null; }
            echo $_ROOT_PATH_;
            echo "styles/black/theme/bidi.css?assets_version=";
...
\t<link href=\"";
        ...
        if (isset($context["ROOT_PATH"])) { $_ROOT_PATH_ = $context["ROOT_PATH"]; } else { $_ROOT_PATH_ = null; }
        echo $_ROOT_PATH_;
        echo "styles/black/theme/tweaks.css?assets_version=";
        if (isset($context["T_ASSETS_VERSION"])) { $_T_ASSETS_VERSION_ = $context["T_ASSETS_VERSION"]; } else { $_T_ASSETS_VERSION_ = null; }
        echo $_T_ASSETS_VERSION_;
        echo "\" rel=\"stylesheet\">
<![endif]-->
