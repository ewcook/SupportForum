...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\db\driver\sqlite3 A phpbb\db\driver\sqlite3 instance.
     */
    protected function getDbal_Conn_DriverService()
    {
        $this->services['dbal.conn.driver'] = $instance = new \phpbb\db\driver\sqlite3();

        $instance->sql_connect('/var/www/phpBB-database/phpBB.db', '', '', '', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.driver.class' => 'phpbb\\db\\driver\\sqlite3',
            'dbal.dbhost' => '/var/www/phpBB-database/phpBB.db',
            'dbal.dbuser' => '',
            'dbal.dbpasswd' => '',
            'dbal.dbname' => '',
            'dbal.dbport' => '',
